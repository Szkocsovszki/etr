...
CREATE TABLE SZAK(
    EHA VARCHAR2(11) REFERENCES SZEMELY(EHA),
...
CREATE TABLE KURZUS(
    ...
    Teremkod VARCHAR2(20) NOT NULL,
	Eloadasa VARCHAR2(20),
	FOREIGN KEY (Teremkod) REFERENCES TEREM(Teremkod) ON DELETE CASCADE,
...
CREATE TABLE VIZSGA(
    ...
    Kurzuskod VARCHAR2(20) NOT NULL REFERENCES KURZUS(Kurzuskod) ON DELETE CASCADE
);
...
CREATE TABLE FORUM(
    ...
    FOREIGN KEY (EHA) REFERENCES SZEMELY(EHA),
    FOREIGN KEY (Kurzuskod) REFERENCES KURZUS(Kurzuskod) ON DELETE CASCADE
);
